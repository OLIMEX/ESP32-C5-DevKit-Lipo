/*
  Olimex ESP32-C5-DevKit-LiPo + MOD-IR-TEMP (MLX90614) Demo
  ---------------------------------------------------------
  ...
  Hardware connections (UEXT pinout):
    UEXT Pin 3 -> SDA  -> ESP32-C5 GPIO2
    UEXT Pin 4 -> SCL  -> ESP32-C5 GPIO3
...
// Define I2C pins for ESP32-C5 (UEXT connector)
#define SDA_PIN 2
#define SCL_PIN 3
...
void setup() {
  ...
  Serial.begin(115200);
  delay(1000);
  Serial.println("\n=== Olimex ESP32-C5 + MOD-IR-TEMP (MLX90614) Demo ===");
