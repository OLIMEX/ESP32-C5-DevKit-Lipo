...
// Compatible with Olimex ESP32-C5-DevKit-Lipo
// Notice! Measuring the battery requires closing PTH jumpers - BAT_PWR_E1 and BAT_SENS_E1;
// External power sense requires closing PTH jumper PWR_SENS_E1;
...
// These are GPIO pins for ESP32-C5-DevKit-Lipo, edit for other boards
#define POWER_SENSE 9
#define BATTERY     6
